            ...
            <form action="{{route('roles.update', $role->id)}}" method="post">
                ...
                <div class="field">
                    ...
                    <div class="control has-icons-right">
                        <input id="display_name" type="text" class="input{{ $errors->has('display_name') ? ' is-danger' : '' }}" name="display_name" value="{{ $role->display_name }}" placeholder="e.g Coach" required autofocus>
