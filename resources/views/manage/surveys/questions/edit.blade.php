            ...
            <form action="{{route('questions.update', $question->id)}}" method="post">
                ...
                <div class="field">
                    ...
                    <div class="control has-icons-left has-icons-right">
                        <input id="name" type="text" class="input{{ $errors->has('name') ? ' is-danger' : '' }}" name="name" value="{{ $question->name }}" placeholder="Name input" required autofocus>
                        ...
                        <div class="select is-fullwidth">
                            <select name="survey" required autofocus>
                                @foreach($surveys as $survey)
                                    <option value="{{ $survey->id }}" {{ $question->survey_id == $survey->id ? 'selected' : '' }}>{{ $survey->name }}</option>
                                @endforeach
                            </select>
                        </div>
