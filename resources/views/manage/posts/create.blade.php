                ...
                <div class="columns">
                    <div class="column is-three-quarters">
                        <div class="field">
                            ...
                            <div class="control has-icons-left has-icons-right">
                                <input id="name" type="text" class="input{{ $errors->has('title') ? ' is-danger' : '' }}"
                                       name="title" value="{{ old('title') }}" placeholder="Title input" required autofocus>
                        ...
                        <div class="field">
                            ...
                            <div class="control has-icons-left has-icons-right">
                                <textarea id="article_content" type="text" class="textarea{{ $errors->has('article_content') ? ' is-danger' : '' }}" name="article_content" placeholder="Content input" autofocus>{{ old('article_content') }}</textarea>
